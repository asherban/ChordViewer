...
Planning baseline: 2026-09-20; delivery status updated 2026-09-21. This is an outcome-level roadmap based on the [product plan](product-plan.md) and [setup and cleanup plan](setup-and-cleanup.md). It does not assign dates or low-level tasks. **M0–M4 are complete.** See the [M1 verification record](../development/m1-verification.md) for tooling, [M2 verification record](../development/m2-verification.md) for the foundation and notation proof, [M3 verification record](../development/m3-verification.md) for persistence, and [M4 verification record](../development/m4-verification.md) for chord authoring on both clients. M5 onward remain planned.
...
| M5 | Initial melody complexity, import format and minimum direct-editing controls; decide whether the v1 C key signature and 4/4 limits should expand. |
