...
Planning baseline: 2026-09-20; delivery status updated 2026-09-22. This is an outcome-level roadmap based on the [product plan](product-plan.md) and [setup and cleanup plan](setup-and-cleanup.md). It does not assign dates or low-level tasks. **M0–M5 are complete; M6 is next.** See the [M1 verification record](../development/m1-verification.md) for tooling, [M2 verification record](../development/m2-verification.md) for the foundation and notation proof, [M3 verification record](../development/m3-verification.md) for persistence, [M4 verification record](../development/m4-verification.md) for chord authoring and [M5 verification record](../development/m5-verification.md) for melody and import/export on both clients. M6 onward remain planned.
